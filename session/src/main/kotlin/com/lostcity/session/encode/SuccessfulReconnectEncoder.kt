...
import com.lostcity.session.type.SuccessfulReconnectResponse
import com.lostcity.session.type.SuccessfulResponse
import jagex2.io.p1
import java.nio.ByteBuffer

@Singleton
class SuccessfulReconnectEncoder : CodecEncoder<SuccessfulReconnectResponse> {
    override suspend fun encode(session: Session, response: SuccessfulReconnectResponse): ByteBuffer {
